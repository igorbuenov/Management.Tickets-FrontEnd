...
@Component({
  selector: 'app-ticket-assignedto',
  imports: [DatePipe, RouterLink],
  templateUrl: './ticket-assignedto.html',
  styleUrl: './ticket-assignedto.css',
})
export class TicketAssignedtoComponent implements OnInit {
  ...
  loadTickets(): void {
    ...
    this.ticketService.getTicketsAssigned(
      this.currentPage(),
      this.pageSize(),
      this.search(),
      this.priority(),
